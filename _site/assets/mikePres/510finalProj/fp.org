...
<img src="./imag/bbm_insert_loss.svg" alt="Simulated vs Measured Insertion Loss" style="width:100%; border: 1px solid #ccc; border-radius: 8px;">
</div>
<div style="flex: 25%;">
<h3 style="font-size: 1.2em; margin-bottom: 0.5em;">Insertion Loss Explanation</h3>
<div style="background: rgba(0,128,0,0.05); padding: 1em 1.5em; border-left: 6px solid #2ca02c; border-radius: 8px;">
#+END_EXPORT
