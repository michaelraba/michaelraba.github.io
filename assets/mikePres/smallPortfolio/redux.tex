...
\maketitle
\begin{frame}[label={sec:org50a8f41}]{Multichamber Muffler}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3e88baf}]{Anand Model: Viscoelastoplasticity and its Application to Solder Joints}
\begin{columns}
\begin{column}{0.88\columnwidth}
\begin{figure}[htbp]
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org15dd6c4}]{Turbulence Suppression (SVD-FFT Method)}
\begin{columns}
\begin{column}{0.88\columnwidth}
\begin{figure}[htbp]
\centering
